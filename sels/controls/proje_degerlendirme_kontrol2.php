...
$sql = "INSERT INTO proje_degerlendirme2 (tc, juri, puan1,puan2,puan3,puan4,puan5,sonuc, type, ek)
VALUES ('$tc', '$juri_id', '$puan1','$puan2','$puan3','$puan4','$puan5','$toplam', $sonuc, '$ek')";
