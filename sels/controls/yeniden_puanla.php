...
$sql = "UPDATE proje_degerlendirme SET tekrar=1 WHERE juri=".$juri_id." AND tc='".$proje_tc."'";
...
$mesajlar.="Mesaj: ".$message."<br/>";
    header("Location: ../proje_detay.php?success=1&proje_id=".$proje_id);
} else {
    header("Location: ../proje_detay.php?error=0&proje_id=".$proje_id);
}
