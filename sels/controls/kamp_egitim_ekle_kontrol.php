...
$sql = "INSERT INTO kamp_egitim (kamp_id, name, bastarih, bitistarih)
VALUES ($kamp_id, '$formfield5', '$date', '$date2')";
if (mysqli_query($conn, $sql)) {
    

    header("Location: ../kamp_egitim_ekle.php?success=1&kamp_id=".$kamp_id);
}
else {
    header("Location: ../kamp_egitim_ekle.php?error=0&kamp_id=".$kamp_id);
}
