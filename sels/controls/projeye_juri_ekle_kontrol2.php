...
print_r($_GET);
 ...
 for($i=0; $i<count($my_multi_select2); $i++){
   ...
   $sql3 =  "INSERT INTO juri_proje2 (juri_id, proje_tc) VALUES (".$my_multi_select2[$i].", '".$proje_tc."')";
...
mail($alici, $konu, $mesajlar, "Content-type: text/html; charset=utf-8\r\n");
   if(!mysqli_query($conn, $sql3)){
       header("Location: ../proje_detay2.php?error=1");
   }
    }
    header("Location: ../proje_detay2.php?success=1");