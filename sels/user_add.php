                            ...
                            <div class="content-body">
                                <div class="row">
                                    <div class="col-md-8 col-sm-9 col-xs-10">
                                        <h2><b>After you create account </b> <br>
										<b>1)Run terminal</b><br>
<b>2)go and run train.py</b><br>
cd FaceFramework/trainDataset<br>
sudo python train.py<br>

										</h2>
                                        
                                         <form id="general_validate" action="controls/juri_ekle_kontrol.php" method="GET" novalidate="novalidate">
											...
											<div class="form-group">
                                                <label class="form-label" for="formfield7">Path Name</label>
                                             ...
                                             <div class="form-group">
                                                ...
                                                <span class="desc"></span>
                                                <div class="controls">
                                                    <input type="text" class="form-control" id="formfield10" name="formfield10" >
                                                </div>
                                            </div>
