                            ...
                            <div class="content-body">    <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="col-xs-offset-4 col-xs-7 col-sm-offset-3 col-sm-9 tocify-content">
                                             ...
                                             <h2>1. Aşama Sonucu: </h2>
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <div class="invoice-head">
                                                    <div class="col-md-3 col-sm-12 col-xs-12 invoice-title">
                                                        <h2 class="text-center <?php if($row["asama"]>0){ echo 'bg-primary" >Başarılı';} else {echo 'bg-danger" >Yetersiz';}?></h2>    
                                                    </div>
                                                    ...
                                                    <span class="text-muted">
                                                            <?php echo $row["basvuru_tarihi"];?>
                                                        </span><br>
														<span style="font-weight:bold;" class="text-muted">
                                                           Proje Kodu:
                                                        </span><br>
                                                    <span class="text-muted">
                                                            <?php echo $row["proje_kod"];?>
                                                        </span>
                                                    </div>
                                                    <div class="col-md-3 col-sm-12 col-xs-12 invoice-head-info"><span class="text-muted">Jüriler<br>
                                                        </span>
                                                    <?php 
                                            ...
                                            while($row_juri=$result_juri->fetch_assoc()){
                                                ...
                                                echo '<span>'.$row_juri["name"].' '.$row_juri["surname"].' ';
                                                if($result_degerlendirme!="err101"){
                                                $row_degerlendirme=$result_degerlendirme->fetch_assoc();
                                                if($row_degerlendirme["sonuc"]=="1") echo " ->Yeterli"; else echo "->Yetersiz";
                                            }
                                            else{
                                                echo "--> Oylanmadı";
                                            }
...
<!--                                                    <div class="col-md-3 col-sm-12 col-xs-12 invoice-logo col-md-offset-1">
                                            ...
                                            echo '<div class="col-md-12 col-sm-12 col-xs-12">
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-hover invoice-table">
                                                        <thead>
                                                            <tr>
                                                                <td><h4>Puan 1</h4></td>
                                                                <td class="text-center"><h4>Puan 2</h4></td>
                                                                <td class="text-center"><h4>Puan 3</h4></td>
                                                                <td class="text-center"><h4>Puan 4</h4></td>
                                                                <td class="text-center"><h4>Puan 5</h4></td>
                                                                <td class="text-center"><h4>Jüri Yorumu</h4></td>
                                               ...
                                               echo'<!-- foreach ($order->lineItems as $line) or some such thing here -->
                                                            <tr>
                                                                    ...
                                                                    <td>'; echo $row_degerlendirme["puan1"]; echo '</td>
                                                                <td class="text-center">'; echo $row_degerlendirme["puan2"]; echo '</td>
                                                                    <td class="text-center">'; echo $row_degerlendirme["puan3"]; echo '</td>
                                                                        <td class="text-center">'; echo $row_degerlendirme["puan4"]; echo '</td>
                                                                            <td class="text-center">'; echo $row_degerlendirme["puan5"]; echo '</td>
                                                                                <td class="text-center">'; echo $row_degerlendirme["ek"]; echo '</td>
                                                                                <td class="text-center">'; echo $row_degerlendirme["sonuc"]; echo '</td>
                                                                        <td class="text-center">'; 
                                                                                
                                                                                if ($row_degerlendirme["puan2"]==0 && $row_degerlendirme["puan3"]==0 && $row_degerlendirme["puan4"]==0 && $row_degerlendirme["sonuc"]==0){
                                                 echo 'Değerlendirilmedi';
                                               }
                                             else if ($row_degerlendirme["puan2"]<10 || $row_degerlendirme["puan3"]<12 || $row_degerlendirme["puan4"]<8 ||$row_degerlendirme["sonuc"]<50){
	...
	echo 'Başarılı';
	 ...
	 echo 'İyileitirilebilir';
}
                                                                                
                                                                                echo '</td>    
                                                                ';
                                                                    if($row_degerlendirme["tekrar"]==0){
                                                                        echo '<td class="text-center"><a href="controls/yeniden_puanla2.php?juri_id='.$row_juri["id"].'&proje_tc='.$row["tc"].'&proje_id='.$proje_id.'" class="btn btn-primary btn-sm" title="Jüri Yeniden Oylasın"><i title="Jüri Yeniden Oylasın" class="fa fa-pencil"></i></a></td>';
                                                               
                                                                    }
                                                                    else if($row_degerlendirme["tekrar"]==2){
                                                                        echo ' <td class="text-center">Yeniden Değerlendirilmiştir</td> ';
                                                                    }
                                                                    else{
                                                ...
                                                echo '<a class="btn btn-danger btn-block" href="controls/juri_iptal2.php?juri_id='.$row_juri["id"].'&proje_tc='.$row["tc"].'&proje_kod='.$row["proje_kod"].'&$proje_id='.$row["id"].'&formfield10=admin tarafindan">'.$row_juri["name"].' '.$row_juri["surname"].' Jürilikten Çıkar</a>';
                                            }
                                            }
                                           ...
                                           <br>
                                            ...
                                            ?>
                                            <br>
                                            <h2>2. Başvuru Dosyaları</h2>
                                            <?php
                                            echo '<p><a href="uploads/'.$row["tc"].'/'.$row["basvuruform2"].'" target="_blank">'.$row["basvuruform2"].'</a></p>';
                                             echo '<p><a href="uploads/'.$row["tc"].'/'.$row["basvuruform22"].'" target="_blank">'.$row["basvuruform22"].'</a></p>';
                                            ?>
                                            <br>
                                            <h2>İyileştirme Dosyası</h2>
                                            <?php
                                          echo '<p><a href="uploads/'.$row["tc"].'/'.$row["basvuruform3"].'" target="_blank">'.$row["basvuruform3"].'</a></p>';
                                            ?>
                                            <br>
                                            <?php 
                                            if($_SESSION["type"]==2){
                                                if($row["seviye"]==3 && $row["ana_asama"]==2){
                                                    echo '<h2>İyileştirme Puanlaması</h2>
                                            <a href="proje_degerlendirme2.php?iyilestirme=1&juri_id='.$_SESSION["id"].'&proje_tc='.$row["tc"].'&proje_id='.$proje_id.'" class="btn btn-primary btn-block">İyileştirme Değerlendirmesi</a><br>';

                                                }
                                                $result_degerlendirme=  db_get_proje_degerlendirme_tek2($conn, $_SESSION["id"], $row["tc"]);
                                                         if($result_degerlendirme!="err101"){
                                                $row_degerlendirme=$result_degerlendirme->fetch_assoc();
                                                if($row_degerlendirme["tekrar"]==1){
                                                    echo '<h2>Tekrar Puanla</h2>
                                            <a href="proje_degerlendirme2.php?juri_id='.$_SESSION["id"].'&proje_tc='.$row["tc"].'&proje_id='.$proje_id.'" class="btn btn-primary btn-block">Tekrar Değerlendir</a><br>';
                                            ...
                                            <a href="" class="btn btn-primary btn-block">Bu Projeyi Zaten Değerlendirdiniz.</a><br>';
                                                             ...
                                                             echo '<h2>Puanla</h2>
                                            <a href="proje_degerlendirme2.php?juri_id='.$_SESSION["id"].'&proje_tc='.$row["tc"].'&proje_id='.$proje_id.'" class="btn btn-primary btn-block">Değerlendir</a><br>';

                                                
                                                         }
  }
else if($_SESSION["type"]==1){
    echo '<a class="btn btn-success btn-block" href="controls/ana_degerlendirme2.php?id='.$proje_id.'" >Son Aşamaya Geçir</a>';
    echo '<a class="btn btn-warning btn-block" href="controls/on_degerlendirme.php?id='.$proje_id.'" >Ön Değerlendirmeye Geri Döndür</a>';
}
                                        ...
                                        <div class="modal fade" id="ultraModal-1" tabindex="-1" role="dialog" aria-labelledby="ultraModal-Label" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="controls/projeye_juri_ekle_kontrol2.php" method="GET">
                                        ...
                                        <div class="modal fade" id="ultraModal-2" tabindex="-1" role="dialog" aria-labelledby="ultraModal-Label" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="controls/juri_iptal2.php" method="GET">
                                                    <div class="modal-body">
