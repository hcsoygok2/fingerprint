...
<div class="alert alert-success alert-dismissible fade in">
                                      ...
                                      // header("Location: proje_tek.php");
                                        ...
                                        if($egitim = $conn->query($sql3)){
                                             $row3=$egitim->fetch_assoc();
                                                        ...
                                                        if($row2["seviye"]==3 && $row2["ana_asama"]==2)
                                                        {
                                                            
                                                            
                                                         echo' <form name="b2" id="b2" action="controls/anabasvuru2.php" method="POST" enctype= "multipart/form-data">
														 
														 <input type="hidden" name="tc" value="'.$row2["tc"].'"/>
														 
														 <p>
                                      <label for="foto">Geliştirilebilir Proje Dosyası<br />
					...
					<button type="submit" class="btn btn-primary">Ekle</button>
                                                        ...
                                                        {
                                                            echo 'Üzgünüz '  .$row2["isim"] .' Projeniz Yetersiz Bulunmuştur.';
