                        ...
                        <section class="box ">
                            ...
                            <div class="content-body">   
                                <div class="button_ekle">
                                    <a href="kamp_egitim_ekle2.php?kamp_id=<?php echo $id; ?>" class="btn btn-success btn-lg">Yeni Oluştur</a>
                                </div>
                                <div class="row">
                                        ...
                                        <table id="example-1" class="table table-striped dt-responsive display" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                                <?php 
                                                    ...
                                                    $result=  db_get_kamp_egitim2($conn, $id);
                                                    if($result!="err101"){
                                                    ...
                                                    echo '<tr><td >'.$row["name"].'</td>'
                                                            ...
                                                            . '<td>
                            <a href="kamp_egitim_duzenle2.php?id='.$row["id"].'" class="btn btn-primary btn-sm" title="Düzenle"><i title="Düzenle" class="fa fa-pencil"></i></a>
                            <a href="controls/kamp_egitim_sil_kontrol2.php?id='.$row["id"].'" class="btn btn-danger btn-sm btn-delete" title="Sil"><i title="Sil" class="fa fa-trash-o"></i></a>
                        </td>
                        </tr>';
    }
                                                    }    ?>
                                        ...
                                        <table id="example-1" class="table table-striped dt-responsive display" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                                <?php 
                                                    ...
                                                    $result=  db_get_proje_bykamp2($conn, $id);
                                                    if($result!="err101"){
                                                    while($row = $result->fetch_assoc()) {
                                                    echo '<tr><td style="font-size:x-small;">'.$row["isim"].'</td>'
                                                            . '<td style="font-size:x-small;">'.$row["proje_isim"].'</td>'
                                                            . '<td style="font-size:x-small;">'.$row["email"].'</td>'
                                                            
                                                            . '<td>
                            <a href="controls/egitime_proje_sil_kontrol2.php?id='.$row["id"].'&kamp_id='.$id.'" class="btn btn-danger btn-sm btn-delete" title="Sil"><i title="Sil" class="fa fa-trash-o"></i></a>
                        </td>
                        </tr>';
    }
                                                    }
                                          ...
                                          if($result!="err101"){
                                               while($row_kategori = $result->fetch_assoc()) {
                                                   echo '<optgroup label="'.$row_kategori["isim"].'">';
                                                    $result2= db_get_proje_exclude_kamp2($conn, $row_kategori["isim"]);
                                          if($result2!="err101"){
