...
$result=  db_get_kamp_tek2($conn,$id);
...
<form id="general_validate" action="controls/kamp_kontrol2.php" method="GET" novalidate="novalidate">
    ...
    <div class="form-group">
											...
											<div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" class="form-control" id="formfield6" name="formfield6" value="<?php echo $row_main["bastarih"];?>" >
                                                </div>
                                            </div>
											<div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" class="form-control" id="formfield7" name="formfield7" value="<?php echo $row_main["bitistarih"];?>" >
                                                </div>
                                            </div>
                                            
                                             
                                             <div class="form-group">
                                                <label class="form-label" for="formfield10">Açıklama</label>
                                                <span class="desc"></span>
                                                <div class="controls">
                                                    <input type="text" class="form-control" id="formfield10" name="formfield10" value="<?php echo $row_main["description"];?>" >
                                                </div>
                                            </div>
