                            ...
                            <div class="content-body">    <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                      ...
                                      // header("Location: proje_tek.php");
                                        if($row2["seviye"]==0){
                                             echo "<p>Başvurunuz alınmıştır. Katılımınız için teşekkür ederiz. Lütfen sonuçlar açıklanana kadar bekleyiniz. E-mail yoluyla bildirim yapılacaktır.</p>";
                                        ...
                                        if($egitim = $conn->query($sql3)){
                                             $row3=$egitim->fetch_assoc();
                                                        ...
                                                        {
                                                            echo 'Tebrikler '  .$row2["isim"] .' ana değerlendirmeye geçtiniz<br>';
                                                            
                                                            if($egitim){
                                                                echo "Katılacağınız eğitim ve tarihi:<br>";
                                             echo $row3["name"]."<br> Başlangıç Tarihi: ".$row3["bastarih"]."<br>Bitiş Tarihi: ".$row3["bitistarih"]."<br>";
