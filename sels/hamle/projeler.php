...
<!--                                             <div class="row">-->
                                     ...
                                     $asamalar=array();
                                           ...
                                           $result=  db_get_kategori_juri($conn);
                                            }
                                            else{
                                     ...
                                     echo ' <div class="col-md-4 col-sm-4 col-xs-4">
                                       <div class="r3_notification db_box">
                                            ...
                                            $result2=  db_get_proje_bykategori_juri($conn, $row_kategori["isim"], $_SESSION["id"]);
                                            }
                                            else{
                                                
                                            $result2=  db_get_proje_bykategori($conn, $row_kategori["isim"]);
                                            }
                                          if($result2!="err101"){
                                           ...
                                           $result3=  db_get_proje_degerlendirme_tek($conn, $_SESSION["id"], $row["tc"]);
                                           ...
                                           if($result3=="err101"){
                                             ...
                                             if($row_result["sonuc"]>0){
                                                   echo '<li class="unread '.$asamalar[3].'">';
                                               }
                                               else if($row_result["sonuc"]<0){
                                            ...
                                            $result3=  db_get_sonuc($conn, $row["tc"]);
                                             if($result3=="err101"){
                                              ...
                                              $row_result=$result3->fetch_assoc();
                                             if($row_result["asama"]>0){
                                                   echo '<li class="unread '.$asamalar[3].'">';
                                               }
                                               else if($row_result["asama"]<0){
                                                  echo '<li class="unread '.$asamalar[2].'">';
                                               }
                                               else if($row_result["asama"]==0){
                                                   echo '<li class="unread '.$asamalar[1].'">';
                                               ...
                                               echo '
                                                    <a href="proje_detay.php?proje_id='.$row["id"].'">
                                                        <div class="user-img">
                                                            <img src="images/profile1.jpg" alt="user-image" class="img-circle img-inline">
                                                        </div>
                                                        <div>
                                                            <span class="name">
