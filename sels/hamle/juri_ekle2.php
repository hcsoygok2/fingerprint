                    ...
                    <div class="col-lg-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title pull-left">Juri Ekleme Formu</h2>
                            ...
                            <div class="content-body">
                                <div class="row">
                                    <div class="col-md-8 col-sm-9 col-xs-10">
                                         ...
                                         <form id="general_validate" action="controls/juri_ekle_kontrol2.php" method="GET" novalidate="novalidate">
                                        ...
                                        <select multiple="multiple" class="multi-select" id="my_multi_select2" name="my_multi_select2[]">
                                            ...
                                            <?php
                                            $result=  db_get_kategori2($conn);
                                      
                                          if($result!="err101"){
                                               while($row_kategori = $result->fetch_assoc()) {
                                                   echo '<optgroup label="'.$row_kategori["isim"].'">';
                                                    $result2=  db_get_proje_bykategori2($conn, $row_kategori["isim"]);
                                          if($result2!="err101"){
