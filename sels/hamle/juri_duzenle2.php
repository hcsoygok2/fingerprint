...
<form id="general_validate" action="controls/juri_kontrol2.php" method="GET" novalidate="novalidate">
                                          ...
                                          if($result!="err101"){
                                               while($row_kategori = $result->fetch_assoc()) {
                                                   echo '<optgroup label="'.$row_kategori["isim"].'">';
                                                    $result2=  db_get_proje_bykategori_exclude2($conn, $row_kategori["isim"], $id);
                                          if($result2!="err101"){
