...
<!--                                             <div class="row">-->
                                     ...
                                     echo ' <div class="col-md-4 col-sm-4 col-xs-4">
                                       <div class="r3_notification db_box">
                                            ...
                                            $result2=  db_get_proje_bykategori_juri2_gelistirilebilir($conn, $row_kategori["isim"], $_SESSION["id"]);
                                            }
                                            else{
                                                
                                            $result2=  db_get_proje_bykategori2_gelistirilebilir($conn, $row_kategori["isim"]);
                                            }
                                          if($result2!="err101"){
