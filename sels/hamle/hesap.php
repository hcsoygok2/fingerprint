...
$eposta=$_SESSION["user"];
 ...
 $sql="SELECT * FROM uyeler WHERE posta='".$eposta."'";
                    ...
                    <div class="col-lg-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title pull-left">Hesap Yönetimi</h2>
...
<form id="general_validate" action="controls/hesap_kontrol.php" method="POST" novalidate="novalidate" enctype= "multipart/form-data">
    ...
    <div class="form-group">
											...
											<div class="form-group">
                                                ...
                                                <span class="desc"></span>
                                                <div class="controls">
                                                    <input  readonly="readonly" type="text" class="form-control" id="formfield11" name="formfield11" value="<?php echo $row_main["posta"];?>" >
                                                </div>
                                            </div>
                        ...
                        <label for="foto">Profil Fotoğrafı (İsteğe Bağlı)<br />
                            ...
                            <input type="file" name="foto" id="foto" class="input" value="<?php echo $row_main["foto"];?>" size="20" /></label>
                    </p>
											
								<input type="hidden" name="tc" value=<?php echo $row_main["id"] ?>/>
