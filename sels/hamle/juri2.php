                        ...
                        <section class="box ">
                            ...
                            <div class="content-body">   
                                <div class="button_ekle">
                                    <a href="juri_ekle2.php" class="btn btn-success btn-lg">Yeni Oluştur</a>
                                </div>
                                <div class="row">
                                            ...
                                            <tbody>
                                                <?php 
                                                    ...
                                                    echo '<tr><td>'.$row["name"].'</td>'
                                                            ...
                                                            . '<td>'.$row["password"].'</td>'
                                                            . '<td>
                            <a href="juri_duzenle2.php?id='.$row["id"].'" class="btn btn-primary btn-sm" title="Düzenle"><i title="Düzenle" class="fa fa-pencil"></i></a>
